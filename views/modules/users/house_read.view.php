			...
			<div class="col-md-12">
				<div class="content-panel">
					<table class="table table-striped table-advance table-hover">
						...
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn" id="delete_code"></i> Codigo Casa</th>
								<th class="hidden-phone"><i class="fa fa-question-circle"></i>Nombre Casa</th>
								<th><i class="fa fa-edit" id="update-btc"></i> Actualizar</th>
								<th><i class="fa fa-edit" id="delete-btc"></i> Eliminar</th>
								<th></th>
							</tr>
						</thead>
						<tbody>
